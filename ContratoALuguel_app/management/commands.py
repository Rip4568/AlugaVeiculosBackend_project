#ContratoAluguel_app/management/commands.py
import asyncio
...
from ContratoALuguel_app.models import Contrato

class Command(BaseCommand):
    help = 'Envia emails diários de alerta de vencimento de contrato'
